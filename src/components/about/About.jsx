...
function About() {
  return (
    ...
    <div className="about-text">
        ...
        <p>We currently offer services across Florida, including major cities such as Miami, Doral, Miramar, Fort Lauderdale, Boca Raton, and West Palm Beach. For more information or to make a reservation, please contact us.</p>
